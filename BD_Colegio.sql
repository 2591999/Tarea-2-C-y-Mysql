...
CREATE TABLE `estudiantes` (
  ...
  KEY `id_tipo_sangre_tipos_sangre_estudiante_idx` (`id_tipo_sangre`),
  CONSTRAINT `id_tipo_sangre_tipos_sangre_estudiante` FOREIGN KEY (`id_tipo_sangre`) REFERENCES `tipos_sangre` (`id_tipo_sangre`)
...
INSERT INTO `estudiantes` VALUES (1,'0001',NULL,NULL,NULL,NULL,NULL,NULL),(2,'0002',NULL,NULL,NULL,NULL,NULL,NULL),(3,'0003',NULL,NULL,NULL,NULL,NULL,NULL),(4,'0004',NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2024-05-23  4:04:46
